const story = {
    ...
    start: [
        ...
        { type: 'dialogue', speaker: 'Хвойник', mood: 'neutral', text: '— Ну-ну, полетела она… Идём за мной на площадь! Там тебя уже драконы ждут.' },
    ...
    post_feeding_dialogue: [
        { type: 'setBg', bg: 'bg-room' }, { type: 'hideChars' },
        { type: 'showChar', pos: 'left', name: 'khvoynik', mood: 'neutral' }, 
        { type: 'showChar', pos: 'right', name: 'nora', mood: 'neutral' },
    ...
    // === ДЕНЬ 2 ===
    day2_start: [
        { type: 'setDay', day: 2 }, { type: 'setBg', bg: 'bg-room' }, { type: 'hideChars' },
    ...
    gear_intro: [
        ...
        { type: 'dialogue', speaker: '', text: 'Она проводит лапой по кожаному седлу. Кожа легко поддаётся нажатию, изгибаясь под весом её усилия. Сверху находится мягкая подушка, набитая перьями — всё для комфорта наездника! Пахнет седло смазочным маслом и древесиной. В некоторых местах поверхность покрыта царапинами и потёртостями, значит, оно уже использовалось кем-то до неё. Это хороший знак, потому что новая кожа, как правило, более твёрдая, и на разноску седла требуется некоторое время. А тут всё уже готово!' },
        { type: 'dialogue', speaker: '', text: 'Седло должно крепиться к туловищу дракона кожаными ремешками с железными кольцами. Дырки в ремешках были почти не изношенными, на металле не было видно ржавчины. Рядом лежала упряжь с поводьями, которая крепилась к седлу. Упряжь была сконструирована так, чтобы она могла принимать форму головы любого дракона без дискомфорта для последнего.' },
        { type: 'dialogue', speaker: '', text: 'На другой стороне склада лежало металлическое снаряжение. Предрассветная Мгла постучала когтем по поверхности боковой брони, она издала приятный гулкий звон. Трудно было сказать, из какого металла всё это сделано. Скорее всего, это были залежи горных пород, закалённые в огне и принявшие свою форму благодаря работе мастера-кузнеца.' },
        { type: 'dialogue', speaker: '', text: 'Броня была пластинчатая, что позволяло ей не так сильно сковывать движения дракона. И всё же она из-за своего веса могла помешать его манёвренности. Броня крепилась к телу при помощи ремешков, защищая наиболее важные участки: голову, шею, спину и бока. Открытыми оставались лишь брюхо, так как дракон вряд ли подставит его в полёте, и крылья, так как им требуется лёгкость. В остальном броня являлась прекрасным вариантом для наездника, который хочет обеспечить себя и дракона надёжной защитой от возможных столкновений.' },
    ...
    gear_choice: [
        ...
        { type: 'choice', options: [
            { text: 'Легкое кожаное седло (Скорость)', jumpTo: 'gear_result', params: 'saddle' },
            { text: 'Укрепленная чешуйчатая броня (Защита)', jumpTo: 'gear_result', params: 'armor' },
    ...
    gear_saddle_desc: [{ type: 'dialogue', speaker: '', text: 'Предрассветная Мгла решила, что нет смысла защищаться от препятствий, если их можно просто облететь! Потому её выбор пал на кожаное снаряжение. Она взвалила его на свои плечи и подошла к дракону. Тот уже всё понял и заранее встал на все четыре лапы. Она долго вертелась возле него, устанавливая седло и закрепляя ремешки. Вот последняя шпилька попала на нужное место, Предрассветная Мгла сильно потянула ремешок на себя, чтобы он смог закрепиться вокруг туловища дракона.\n\nОна отряхнула свои лапы от пыли и сделала несколько шагов назад, чтобы увидеть результат. Мягкое кожаное седло было закреплено на спине дракона, упряжь обхватывала верхнюю часть его головы, а поводья были закинуты на рог седла.' }, { type: 'jump', to: 'gear_reaction' }],
    gear_armor_desc: [{ type: 'dialogue', speaker: '', text: 'Кому нужны полумеры, когда можно обеспечить себя надёжной защитой? Вот и Предрассветная Мгла решила также, таская за собой большие железные пластины. Дракон заранее встал на четыре лапы. Долго она вертелась вокруг него, примеряя пластины и скрепляя их вместе, пока они не стали повторять форму его тела.\n\nОна отряхнула свои лапы от пыли и сделала несколько шагов назад, чтобы увидеть результат. Металлическая броня отливала ярким блеском на солнце. Каждое сочленение было туго закреплено, чтобы избежать проблем во время полёта. Металл покрывал спину, бока и часть головы дракона. Упряжь была плотно закреплена на его голове и шее, поводья свисали со спины, седло умещалось на верхушке его спины. Она могла быть уверена, что с такой защитой им не страшны никакие препятствия.' }, { type: 'jump', to: 'gear_reaction' }],
    ...
    day2_end: [
        { type: 'hideChars' }, { type: 'showChar', pos: 'right', name: 'nora', mood: 'neutral' },
        { type: 'dialogue', speaker: '', text: 'Предрассветная Мгла провозилась почти до самого вечера. Дракон нетерпеливо бил себя хвостом по бокам. Завтра будет важный день, завтра она будет пожинать плоды собственных усилий. Остаётся лишь надеяться, что она сделала правильные выборы. Эх, дали бы ей возможность полетать на её Свартфаре, она бы всех победила влёгкую!' },
    ...
    // === ДЕНЬ 3 ===
    day3_start: [
        { type: 'setDay', day: 3 }, { type: 'setBg', bg: 'bg-room' }, { type: 'hideChars' },
        ...
        { type: 'setBg', bg: 'bg-sky' }, // Ночная прогулка
    ...
    night_good: [
        ...
        { type: 'dialogue', speaker: '', text: 'Предрассветной Мгле при виде её дракона сразу стало теплее на душе. Она подошла к нему и осторожно положила лапу на его бок, который продолжал мерно подниматься и опускаться. Дракон покорно закрыл оставшийся глаз. Под её лапой дышало живое существо. Хоть они и не могли переговариваться друг с другом, но между ними было полное взаимопонимание. Конечно, выбор между этим драконом и её Свартом даже не стоит, но, странное дело, она привязалась к этой чешуйчатой туше.' },
    ...
    night_neutral: [
        { type: 'action', func: 'showDragonAndNora' },
        { type: 'dialogue', speaker: '', text: 'Она решила не приближаться к нему. Дракону нужен свой сон, нечего его тревожить. Тот не выказывал к Предрассветной Мгле ни капли враждебности, но по его открытому глазу было видно, что он готов действовать в случае опасности. За три дня им так и не удалось подружиться. Дракон по-прежнему с настороженностью относился к наезднице. Но и врагами они не стали, так что он не спихнёт её прямо в полёте.' },
        { type: 'dialogue', speaker: '', text: 'Она ещё немного погуляла по тропинкам и вернулась в дом. Матрас привычно скрипнул под её весом. В этот раз сон послушно открыл для неё свои двери — и она не смела ему отказывать.' },
        { type: 'jump', to: 'race_intro' }
    ],
    ...
    race_intro: [
        ...
        { type: 'dialogue', speaker: '', text: 'Предрассветная Мгла в последний раз проверила на драконе всё снаряжение. Ремешки были туго затянуты, ничего не болтается, поводья сами просятся в лапы. Она залезла на дракона сверху и села в седло. Оно привычно прогнулось под её весом. Пора выходить.' },
        { type: 'dialogue', speaker: '', text: 'Атмосфера гонок была потрясающей. В небе светило яркое солнце, трибуны зарывались приветственным хором, рог трубил боевые мотивы. Остальные участники занимались своими делами. Кто-то в сотый раз проверял снаряжение, кто-то трясся от страха, кто-то пил мёд, что явно плохо скажется на его координации. Предрассветная Мгла внешне казалась спокойной, лишь подрагивание её ушей выдавало внутреннее волнение.' },
    ...
    race_bad_ending: [
        ...
        { type: 'dialogue', speaker: '', text: 'Её дракон оторвался от земли и понёсся вперёд. Свист и ужас, биение сердца, зашкаливающий адреналин — это то, ради чего стоит жить! Драконы приблизились к первому повороту. Она впереди всех. Предрассветная Мгла дёрнула поводья, чтобы повернуть влево, но дракон вдруг её не послушался. Он медленно качнулся вправо. Она приложила все свои усилия, чтобы не упасть. Дракон едва слышно фыркнул и перевернулся в полёте.' },
        { type: 'dialogue', speaker: '', text: 'Предрассветная Мгла сорвалась. Она камнем полетела вниз под свист шокированных зрителей. В последнее мгновение она увидела морду своего дракона. Тот смотрел на неё через узкие щёлки глаз с выражением абсолютного презрения. Дай ему тысячу попыток — и он каждый раз будет поступать также. Это была холодная, леденящая ненависть. Затем он отвернул голову. Кошка продолжила падать, не успев даже издать крик из-за неожиданности.' },
        ...
        { type: 'showChar', pos: 'right', name: 'nora', mood: 'angry' },
        { type: 'showChar', pos: 'left', name: 'khvoynik', mood: 'angry' },
        { type: 'dialogue', speaker: 'Хвойник', mood: 'angry', text: '— Это что вообще было?! Как… В смысле… Почему он сбросил тебя?' },
        { type: 'dialogue', speaker: 'Предрассветная Мгла', mood: 'angry', text: '— Я… Я не знаю! Чёртов дракон! А я знала, я видела всё это, как он смотрел на меня, словно на протухшую рыбу! Но даже я не могла бы и на секунду представить, что он выкинет такое!' },
    ...
    race_start: [
        { type: 'setBgFunc', func: `engine.state.dragon === 'thunder' ? 'bg-water' : 'bg-sky'` },
        { type: 'dialogue', speaker: '', text: 'Её дракон сразу вырвался в лидеры! Свист в ужас, биение сердца, зашкаливающий адреналин — это то, ради чего стоит жить! Первый поворот, второй, третий — они идеально входили в каждый из них. Седло скрипело под ней, поводья натягивались, азарт захлёстывал разум. И вот финишная прямая! Ещё несколько метров — и Предрассветная Мгла станет победительницей в гонке!' },
    ...
    race_win: [
        ...
        { type: 'dialogue', speaker: 'Хвойник', mood: 'neutral', text: '— Да-да, ты самая лучшая, ты снова победила, молодец, может, пойдём уже?' },
